  ...
  methods: {
            ...
            if (res.data.Code == 0) {
              ...
              if (this.$store.state.visa.certificateInfo.Country == "英国") {
                if (id == 6 && this.$store.state.visa.certificateInfo.Country == "英国") {
                  ...
                  /*if(this.userVisaInfo.ShowTagInfo[3].Tag == "JTUK07"){
                      // 亲戚
                      this.ENGqinqi = this.userVisaInfo.ShowTagInfo[3].Children["0"]["0"].Children["0"]
                      var len = this.userVisaInfo.ShowTagInfo[3].Children["0"]["0"].Children["0"].length
                      console.log(this.userVisaInfo.ShowTagInfo[3].Children["0"]["0"].Children["0"][len-1]);
                      if(this.userVisaInfo.ShowTagInfo[3].Children["0"]["0"].Children["0"][len-1].Tag == "JTUK0708"){
                          // 英国团签
                          // 是否有访问他的计划
                          this.visitqinqi = []
                          for(var i = 0;i<this.userVisaInfo.ShowTagInfo[3].Children["0"]["0"].Children["0"].length/8;i++){
                            var index = (i+1)*8-1
                            this.visitqinqi.push(this.userVisaInfo.ShowTagInfo[3].Children["0"]["0"].Children["0"][index].Children)
                          }
                      }else{
                          // 是否有访问他的计划
                          this.visitqinqi = []
                          ...
                          for(var i = 0;i<this.userVisaInfo.ShowTagInfo[3].Children["0"]["0"].Children["0"].length/8;i++){
                            var index = (i+1)*8-1
                            this.liveEngReason.push(this.userVisaInfo.ShowTagInfo[3].Children["0"]["0"].Children["0"][index].Children)
                          }
                      }
            ...
            function(res) {
              if (res.data.Code == 0) {
                ...
                if (this.groupId == 1 && this.$store.state.visa.certificateInfo.Country != "美国EVUS") {
                  ...
                  /*if(this.userVisaInfo.ShowTagInfo[5].Children["0"][5].ValueCHS == "长期"||this.userVisaInfo.ShowTagInfo[5].Children["0"][5].ValueENG == "long"){
                    this.userVisaInfo.ShowTagInfo[5].Children["0"][5].FieldType = 0
                    this.userVisaInfo.ShowTagInfo[5].Children["0"][5].ValueCHS = "长期"
                ...
                /*if(this.groupId == 6&&this.$store.state.visa.certificateInfo.Country=="英国"){
                  // 有几个需要经济支持的人 JTUK0801
                  this.ENGJJZC = this.userVisaInfo.ShowTagInfo[2].Children["0"]["0"].Children["0"]
                  // 亲戚
                  this.ENGqinqi = this.userVisaInfo.ShowTagInfo[3].Children["0"]["0"].Children["0"]
    ...
    returnInfo(valC, valE, tag, info) {
      ...
      if (tag && tag.match(new RegExp(/^GP/))) {
        ...
        "LXUSABC0030102" || tag == "CJUSA000611" || tag == "CJUSA0010") {
