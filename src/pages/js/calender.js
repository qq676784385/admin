window.calendar = (function() {
    ...
    var W = (function() {
        ...
        function Prev() {
            ...
            C = document.getElementById("year-select")
            X = document.getElementById("month-select")
            if (p === 0) {
                if (s.j > nowYear) {
                    C.value = --s.j;
                    X.value = 12;
        ...
        function d(k, g) {
            ...
            for (var j = nowYear; j < 2050; j++) {
                ...
                // C.appendChild(h)
                document.getElementById("year-select").appendChild(h)
            }
            for (var j = 1; j < 13; j++) {
                var h = R("OPTION");
                h.value = j;
                ...
                // X.appendChild(h)
                document.getElementById("month-select").appendChild(h)
            }
            document.getElementById("year-select").onchange = f;
            document.getElementById("month-select").onchange = f;
    ...
    var N = (function() {
        ...
        function C() {
            ...
            for (var a = 0; a < c.length; a++) {
                ...
                if (c[a].isToday) {
                    //选中cell的背景色和边框颜色
                    X.style.cssText = "background:#cde9d9;padding:2px 0;"
                }
                X.className = "cell";
